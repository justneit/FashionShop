    ...
    ?> 
                                ...
                                <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig" data-wow-delay="0.2s">
                                    ...
                                    <div class="product-img">
                                        <img src="<?php echo $data['timkiem'][$i]['hinhanhSP'] ?>" alt="">
                                    ...
                                    <div class="product-description">
                                        <h4 class="product-price"><?php echo $data['timkiem'][$i]['gia'] ?> $</h4>
                                        <p><?php echo $data['timkiem'][$i]['tenSP'] ?></p>
                                        <!-- Add to Cart -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-7">
                                        ...
                                        <div class="quickview_pro_des">
                                            ...
                                            <h5 class="price"><?php echo $data['timkiem'][$i]['gia'] ?> $ </h5>
                                            <p><?php echo $data['timkiem'][$i]['mota'] ?></p>
                                            <a href="/doan/chitiet/chitietsp?idsp=<?php echo $data['timkiem'][$i]['ID'] ?>">View Full Product Details</a>
                                        </div>
